...
const PARAM_KEYS = ['rx','fu','rp','sp','zp','sc','ep','cp','rh','sip','cnp','sup'];
...
export function restore(PL, ic) {
  ...
  for (const k of STATE_KEYS) PL[k] = clone(ic.state[k]);

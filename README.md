...
lib/         physics modules (21) — imported by the shell
...
The board carries **304 annunciator windows in 19 sections** and **69 control
...
## Annunciator
304 windows in 19 bays, each window reading a distinct piece of plant state.
